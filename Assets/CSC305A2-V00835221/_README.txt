For:
	UVic CSC 305: Introduction to Computer Graphics
	Spring 2019
	Assignment 2 - Procedural Terrain & Shaders
...
This project is made using Unity 2018.2.14f1 for the CSC 305 course at the University of Victoria, and is meant to be a learning tool to investigate the use of procedural mesh generation techniques such as perlin noise based height mapping and the use of custom shaders.
...
--------------------------------------------------------------	
The features of this project are described briefly as follows:
--------------------------------------------------------------
- Highly customizable within the Unity Editor, with dynamic updating as changes are made
...
*** 
NOTE: If the terrain object goes black and unlit, hit the GenerateMesh button on the TerrainGenerator component to recompute the values needed for the shader.
***
...
Sebastian Lague (https://www.youtube.com/channel/UCmtyQOKKmrMVaKuRXz02jbQ)
	- Excellent tutorial and guide on procedural mesh generation (playlist available on youtube)
...
Keijiro Takahashi (https://github.com/keijiro/PerlinNoise)
	- C# implementation of Ken Perlin's noise functions
...
Unity3D (https://unity3d.com/learn/tutorials/topics/graphics/making-transparent-shader)
	- Transparent shader (for water shader) as well as other guides on using CG shaders in Unity